...
const dbGK = [
  ...
  "فابيان بارتيز", 
   "فرانشيسكو تولدو", "ينس ليمان", "جيرزي دوديك", "كاسبر شمايكل",
  "هاندانوفيتش", "ياسين بونو", "محمد الشناوي", "عصام الحضري", "أوناي سيمون",
  "ميك ماينان", "دافيد رايا", "جوردان بيكفورد", "غوليلمو فيكاريو",
  ...
  "إدوارد ميندي", "دين هيندرسون",
  "أرون رامسديل", "أنتوني سيلفا",  "أوليفر باومان", "أندريه أونانا",
  "كيبا أريزابالاغا", "ماركو سبورتيلو", "ماتيا بيرين", 
  "خوان موسو", "أليكس ريميرو", "أندري لونين", "إيفان بروفيديل",

  // ==========================================
  // الجزء الثاني: 30 حارس مرمى عادي أو معروف (ضعيف إلى متوسط)
  // ==========================================
  "لوريس كاريوس", "جو هارت", "روبرت سانشيز",
  "نيتو", "إيناكي بينيا", "أدريان", "ماركوس بيتينلي",
  "أليكساندر نوبل", "سفين أولرايش", "أنتونيو ميرانتي", "تيم كرول", "نيك بوب",
  "بارت فيرباتبروجين", "محمد أبو جبل", "أحمد الشناوي", 
  "فاروق بن مصطفى", "رايس مبولحي", "منير المحمدي",
  "فواز القرني", "معتز ياسين",
];
const dbDEF = [
  // ==========================================
  ...
  "كليمنت لينغليت", "تاكيهيرو تومياسو", "إيميريك لابورت",
  "تيلو كيرير", "دينيس أوجوجو", "هيكتور بيليرين", "نيكولاس أوتاميندي", "جابرييل ",
...
const dbMID = [
  ...
  "جون أوبراين", "مارك كاسادو",
  "شيموس كولمان", "لوكاس توريرا", "لوبيز", "أمادو أونانا", "ماركوس يورينتي"
];
const dbFWD = [
  // ==========================================
  ...
  "داني ويلبيك", "لوك دي يونغ", "خوسيلو", "تشوبو-موتينغ", "سيردار دورسون",
