...
const dbGK = [
  ...
  "جانلويجي دوناروما", "ديفيد دي خيا", "هوغو لوريس", "كيلور نافاس",
  "ينس ليمان", "جيرزي دوديك", "كاسبر شمايكل",
  "هاندانوفيتش", "ياسين بونو", "محمد الشناوي", "عصام الحضري", "أوناي سيمون",
  "ميك ماينان", "دافيد رايا", "جوردان بيكفورد",
  "فويتشيك شتشيسني", "يان سومر", "جريجور كوبيل","روي باتريسيو",
  "أنتوني لوبيز", "غييرمو أوتشوا", "كلاوديو برافو", "سيرخيو روميرو",
  "إدوارد ميندي", "دين هيندرسون", "أرون رامسديل", "أنتوني سيلفا","أندريه أونانا",
  "كيبا أريزابالاغا","أندري لونين",
  "لوريس كاريوس", "جو هارت", "روبرت سانشيز", "نيتو", "إيناكي بينيا", "أدريان",
  "أليكساندر نوبل", "سفين أولرايش", "أنتونيو ميرانتي", "تيم كرول", "نيك بوب",
  "محمد أبو جبل", "أحمد الشناوي","رايس مبولحي",
  "معتز ياسين"
];
const dbDEF = [
  ...
  "باتريس إيفرا", "أشرف حكيمي","أنطونيو روديغر", "تياغو سيلفا",
  ...
  "ماتيس دي ليخت", "ياپ ستام", "سول كامبل","ستيفان دي فري",
  "مهدي بن عطية","علي معلول", "أحمد حجازي",
  "وائل جمعة", "إبراهيم سعيد", "هاني رمزي","محمد عبد المنعم",
  "لوك شو", "ستانيسلاف لوبوتبكا", "كييران تريبير", "يوسكو غفارديول", "بنجامين بافارد",
  "إريك داير", "هاري ماغواير", "ديفيد لويز", "ديان لوفرين",
  "كورت زوما", "ناثان أكي", "ييري مينا", "خيسوس فاييخو",
  "كليمنت لينغليت","إيميريك لابورت",
  "هيكتور بيليرين", "نيكولاس أوتاميندي", "جابرييل ",
  "سام برودفوت", "أندرياس كريستنسن", "ماتيا دي شيليو",
  "آرون وان بيساكا", "سيرجينو ديست", "محمود علاء", "علي جبر"
];
const dbMID = [
  ...
  "غايتانو شيريا", "دييغو سيميوني", "كاسميرو", "خافيير زانيتي",
  ...
  "سكوت ماكتوميناي","جيسي لينغارد", "أليكس أكسليد تشامبرلين", "هاري وينكس",
   "أندريه غوميز", "داني سيبايوس", "ديلي ألي",
  "روبن نيفيز","يوسف فوفانا",
  "سعيد بن رحمة",
  "مارك كاسادو","لوكاس توريرا", "لوبيز", "أمادو أونانا", "ماركوس يورينتي"
];
const dbFWD = [
  ...
  "أنطوان غريزمان", "إدين هازارد", "غاريث بيل", "كارلوس تيفيز", "أليساندرو بييرو",
  ...
  "دييغو فورلان", "كلينسمان", "دانييل أورتيغا", "كريستيان فييري",
  "ماريو بالوتيلي", "نيكولاس جاكسون", "شيرو إيموبيلي","تيمو فيرنر",
  "داروين نونيز", "ريتشارليسون", "ويلفريد زاها", "سيباستيان هالير",
  "ألفارو موراتا", "أنتوني", "أنطوني مارسيال", "ممفيس ديباي",
  "سالم الدوسري","أوليفييه جيرو", "ووت فيغورست",
  "داني ويلبيك", "لوك دي يونغ", "خوسيلو", "تشوبو-موتينغ",
  "أليكساندر لاكازيت", "فينسنت أبوبكر", "أندي كارول", "سيرجي غنابري", "إيغالو"
];

const topStars = [
  "جانلويجي بوفون", "ليف ياشين", "إيكر كاسياس", "مانويل نوير", "أوليفر كان", "تيبو كورتوا", "بيتر شمايكل", "إدوين فان دير سار", "بيتر تشيك", "كاسبر شمايكل",
  "باولو مالديني", "فرانتس بيكنباور", "سيرخيو راموس", "فرانكو باريزي", "فابيو كانافارو", "كارليس بويول", "داني ألفيش", "ياپ ستام", "روبرتو كارلوس", "أليساندرو نيستا", "جون تيري", "سول كامبل", "نيمانيا فيديتش", "ريو فرديناند", "كافو", "مارسيلو", "فيليب لام", "خافيير زانيتي", "ليليان تورام", "رونالد كومان", "فيرجيل فان دايك", "دانييل كارفاخال",
  "زين الدين زيدان", "تشافي هيرنانديز", "أندريس إنييستا", "لوكا مودريتش", "أندريا بيرلو", "توني كروس", "لوتار ماتيوس", "رود خوليت", "ميشيل بلاتيني", "زيكو", "سقراط", "بول سكولز", "ستيفن جيرارد", "فرانك لامبارد", "كاكا", "كيفين دي بروين", "باتريك فييرا", "روي كين", "ديفيد بيكهام", "مسعود أوزيل",
  "ليونيل ميسي", "كريستيانو رونالدو", "بيليه", "دييغو مارادونا", "رونالدو الظاهرة", "رونالدينيو", "يوهان كرويف", "فرينك بوشكاش", "أوزيبيو", "غارينشا", "تييري هنري", "ماركو فان باستن", "جيرد مولر", "كيليان إمبابي", "محمد صلاح", "روبرت ليفاندوفسكي", "زلاتان إبراهيموفيتش", "لويس سواريز", "صامويل إيتو", "نيمار جونيور"
];

const midStars = [
  "يان أوبلاك", "مارك أندريه تير شتيغن", "مايك ماينان", "إيميليانو مارتينيز", "أندري لونين",
  "أنطونيو روديغر", "تياغو سيلفا", "جورجيو كيليني", "ليوناردو بونوتشي", "جيرارد بيكيه", "ألكسندر أرنولد", "ألفونسو ديفيز", "تيو هيرنانديز", "كايل ووكر", "دافيد ألابا", "رافاييل فاران", "ماتس هوملز", "دييغو غودين", "يوسكو غفارديول", "ماتيس دي ليخت",
  "سيرجيو بوسكيتس", "رودري", "جود بيلينغهام", "نغولو كانتي", "سيسك فابريغاس", "كاسميرو", "كلاوديو ماكيليلي", "باستيان شفاينشتايغر", "تشابي ألونسو", "ويسلي سنايدر", "خوان رومان ريكلمي", "ديكو", "فرينكي دي يونغ", "مارتين أوديجارد", "فيديريكو فالفيردي", "جمال موسيالا", "فلوريان فيرتز", "إلكاي غوندوغان", "ماركو فيراتي", "تياغو ألكانتارا", "خاميس رودريغيز", "إيسكو",
  "كريم بنزيما", "إرلينغ هالاند", "واين روني", "ديدييه دروغبا", "رود فان نيستلروي", "أندري شيفتشينكو", "غابرييل باتيستوتا", "روماريو", "ريفالدو", "جورج وياه", "راؤول غونزاليس", "دافيد فيا", "روبين فان بيرسي", "أريين روبن", "فرانك ريبيري", "سيرخيو أجويرو", "هاري كين", "فينيسيوس جونيور", "ساديو ماني", "أنطوان غريزمان", "إدين هازارد", "غاريث بيل", "أليساندرو دل بييرو", "فرانشيسكو توتي", "روبرتو باجيو", "دينيس بيركامب", "راداميل فالكاو", "إدينسون كافاني", "فيكتور أوسيمين", "خوليان ألفاريز", "لاوتارو مارتينيز", "بوكايو ساكا", "سون هيونغ مين", "رياض محرز", "خفيتشا كفاراتسخيليا", "لويس فيغو", "باولو ديبالا", "دييغو فورلان"
];
...
const guessPlayers = [
    ...
    "بول سكولز", "واين روني", "ريان غيغز", "راشفورد ",
    "زلاتان إبراهيموفيتش", "أليساندرو ديل بييرو", "فرانشيسكو توتي", "أندريا بيرلو", " كومباني",
    "فيليبو إنزاغي", "لويس فيغو ", "جابرييل باتيستوتا", " موراتا",
    " كيميتش ", "خوليت", "زيدان", "كافو",
    ...
    "موراتا ", "فرناندو توريس", "ماركو رويس", "توماس مولر",
    ...
    "ماتيس دي ليخت", "جيريمي فريمبونج", "ديل علي ", "كولو مواني",
    ...
    "نيكو ويليامز", "أليكس جريمالدو", "مارك كوكوريلا", " كول بالمر",
    "فابينيو", "ريو فرناند", "أنتوني", "رافينيا",
    ...
    "كريستيان روميرو", "ليونيل ميسي ", "رودريجو دي باول", "ماركينيوس ",
    "ماريو جوتزه", "كوبل ", "بالينيا ", "كاي هافيرتز", " فيرتز",
    "ماتس هوملز", "جيروم بواتينغ", "ليون جوريتسكا", "جوشوا كيميتش", "ألفارو موراتا",
    "دييغو كوستا", "محمد هاني", "كيليان امبابي ",
    "روميلو لوكاكو", "إيدين هازارد", "فينسنت كومباني", "ايزاك ",
    " اوليفر كان", "الحضري ", "شوبير ", "اتكيتي ",
    "جيريمي دوكو", " مارتين اوديجارد", " ديفيد رايا ", "مانويل نوير ", "الشناوي",
    "داني اولمو ", "ألكسندر إيزاك", "فيكتو اوسمين ", "لامين يمال ",
    "فيلب لام ", "جرانيت تشاكا", "روبن دياز "
];
...
let availEasy = []; let availMedium = []; let availHard = [];

// 2. نمط توزيع الأسئلة (5 سهل، 3 متوسط، 1 صعب)
const difficultyPattern = ['easy', 'easy', 'easy', 'easy', 'easy', 'medium', 'medium', 'medium', 'hard'];
let currentPatternIndex = 0;

document.querySelectorAll('.hp-count').forEach(btn => {
    btn.addEventListener('click', (e) => {
        document.querySelectorAll('.hp-count').forEach(b => b.classList.remove('active'));
        e.target.classList.add('active');
        hpPlayerCount = parseInt(e.target.getAttribute('data-value'));
        
        document.getElementById('hp-p3-input').classList.toggle('hidden', hpPlayerCount < 3);
        document.getElementById('hp-p4-input').classList.toggle('hidden', hpPlayerCount < 4);
    });
});
...
document.getElementById('btn-start-hp-wheel').addEventListener('click', () => {
    ...
    for(let i=1; i<=hpPlayerCount; i++) {
        ...
        hpPlayers.push({ name: name, time: STARTING_TIME, isOut: false, index: i-1 });
    }
    ...
    setTimeout(() => {
        ...
        const totalRotation = (360 * 5) + (360 - (winnerIndex * (360 / hpPlayerCount)) - (180 / hpPlayerCount));
        hpWheel.style.transform = `rotate(${totalRotation}deg)`;

        setTimeout(() => {
            document.getElementById('hp-wheel-result').innerText = `البداية مع: ${hpPlayers[currentHpIndex].name} 💣`;
...
// 3. الدالة الذكية لسحب الأسئلة بناءً على النمط
function drawHpQuestion() {
    let neededDifficulty = difficultyPattern[currentPatternIndex];
    let targetBank, targetAvail, labelPrefix;

    // تحديد السلة والتصنيف
    if (neededDifficulty === 'easy') {
        targetBank = hpEasyBank; targetAvail = availEasy; labelPrefix = "🟢 سهل:";
    } else if (neededDifficulty === 'medium') {
        targetBank = hpMediumBank; targetAvail = availMedium; labelPrefix = "🟡 متوسط:";
    } else {
        targetBank = hpHardBank; targetAvail = availHard; labelPrefix = "🔴 صعب:";
    }

    // إعادة تعبئة السلة لو خلصت
    ...
    document.getElementById('hp-question-text').innerText = `${labelPrefix} ${question}`;

    // نقل المؤشر في النمط للدور القادم
    currentPatternIndex = (currentPatternIndex + 1) % difficultyPattern.length;
}

function showPassScreen() {
    clearInterval(hpTimer);
    document.getElementById('hp-pass-text').innerText = `أعطِ الهاتف لـ ${hpPlayers[currentHpIndex].name}`;
...
document.getElementById('btn-hp-ready').addEventListener('click', () => {
    ...
    document.getElementById('hp-current-turn-name').innerText = `دور: ${hpPlayers[currentHpIndex].name}`;
    drawHpQuestion();
    updateHpTimerUI();
...
function eliminateCurrentPlayer() {
    ...
    if (activePlayers.length === 1) {
        alert(`🏆 مبرووووك! الفائز بلقب بطل الضغط العالي هو: ${activePlayers[0].name} 🎉`);
        hideAllScreens();
